...
describe('popularHandler', function () {
	...
	describe('with channel secrets', function () {
		...
		it('calls client.getPopularRelated)', function () {
			expect(client.getPopularRelated).toHaveBeenCalledTimes(1);
			const expected = Object.create(null);
			expected.apiKey = 'api-key-foo';
			expected.secretKey = 'api-secret-bar';
			expect(client.getPopularRelated).toHaveBeenCalledWith(expected);
		});
	});
});
